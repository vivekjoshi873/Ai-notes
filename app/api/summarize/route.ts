...
/**
 * API Route for AI-powered note summarization
 * Uses Groq's Llama model to generate summaries (FREE & FAST!)
    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a helpful assistant that creates concise, clear summaries of notes. Keep summaries brief (2-4 sentences) and focus on the main points.'
          },
          {
            role: 'user',
